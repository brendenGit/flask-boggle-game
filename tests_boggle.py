...
class BoggleTests(TestCase):
    ...
    def test_check_valid_word(self):
        ...
        result_valid_word = self.boggle.check_valid_word(self.boggle.make_board(), valid_word)
        result_invalid_word = self.boggle.check_valid_word(self.boggle.make_board(), invalid_word)
        result_not_a_word = self.boggle.check_valid_word(self.boggle.make_board(), not_a_word)
